    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link href="/interviewers" className="inline-flex items-center space-x-2 text-green-600">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          {!success ? (
            <>
              <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center">Become an Interviewer</h1>
              <p className="text-gray-600 text-center mb-8">Create your interviewer account</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  {loading ? (
                    ...
                    <span>Create Interviewer Account</span>
                  )}
                </button>
              </form>
            ...
            <div className="text-center py-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Interviewer Account Created!</h2>
              <p className="text-gray-600 mb-4">
                You've received 500 free credits to start verifying
              </p>
